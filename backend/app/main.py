...
# CORS origins are environment-driven in production while retaining the
# local Live Server origins for development. Example:
# CORS_ORIGINS=https://handyhire.vercel.app,https://www.handyhire.example
_local_origins = [
    "http://127.0.0.1:5500",
    "http://localhost:5500",
]
...
allowed_origins = list(dict.fromkeys(_local_origins + _configured_origins))
