/* =========================================================
   HandyHire - On-spot Home JavaScript
   Variant of the Customer Home that only renders workers
   available for immediate / on-spot service. Reuses css/home.css.
   ========================================================= */
...
(function () {
    ...
    /**
     * Render the on-spot service grid into the DOM from
     * backend data.
     ...
     * (on-spot) has no target and just stays in place.
     */
    ...
    function initWorkerCards() {
        ...
        function navigate(card) {
            ...
            try {
                ...
                sessionStorage.setItem('handyhire.customer.previousPage', 'home-onspot.html');
            } catch (e) {
